...
<head>
  ...
  <link href="../weekly-calendar/css/materialize.css" type="text/css" rel="stylesheet" media="screen,projection"/>
  <link href="../weekly-calendar/css/style.css" type="text/css" rel="stylesheet" media="screen,projection"/>
...
<body>
  ...
  <nav class="light-blue lighten-1" role="navigation">
    <div class="nav-wrapper container">
      ...
      <!-- WEB VIEW NAV -->
        <ul class="right hide-on-med-and-down">
          ...
          <li><a class="dropdown-button" href="#!" data-activates="dropdown1">Schedule<i class="material-icons right">arrow_drop_down</i></a></li>
    ...
    <div class="name"> <h4>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Weekly View</h4></div>
