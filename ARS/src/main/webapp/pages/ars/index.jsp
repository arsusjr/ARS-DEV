...
<body>
  ...
  <div class="section no-pad-bot" id="index-banner">
    <div class="container">
      <br><br>
      <h3 class="header center blue-text">Aircondition Reservation System</h1>
      <div class="row center">
        <h5 class="header col s12 light">reservation without the hassle</h5>
      </div>
      <div class="row center">
    ...
    <div class="container">
      <div class="row">
        <div class="col l6 s12">
          ...
          <p class="black-text text-lighten-1">We are a team of college students working on this project like it's our full time job. Any amount would help support and continue development on this project and is greatly appreciated.</p>
